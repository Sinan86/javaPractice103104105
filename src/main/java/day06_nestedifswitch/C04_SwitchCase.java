...
//BulunanGun = (kacGunSonrasi + kacıncıGun) % 7;
        ...
        System.out.println("Pazartesi  : 1 \t" +
                           ...
                           "Pazar      : 7 \t " +
                           "       " );
        System.out.println("Haftanin kacinci gununde oldugunuzu giriniz...");

        int kacinciGün =input.nextInt();
        if(kacinciGün<=0||kacinciGün>7){
            System.out.println("Hatali veri girdiniz...");

        }else{
            System.out.println("Kac gun sonrasini bilmek istiyorsunuz..");
            int kacGunSonrasi= input.nextInt();
            int bulunanGun= (kacGunSonrasi+kacinciGün)%7;
